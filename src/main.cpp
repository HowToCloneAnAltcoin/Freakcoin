...
const string strMessageMagic = "WINTERCOIN Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WINTERCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	printf("Searching for genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0abc0f12f8f1f72351d5504b70ef7c33ad3144eabf5be95920e95366c3e4a5ed"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xf2, 0x3c, 0x4e };
